...
const translations = {
  'pt-BR': {
    ...
    'videos.featured': 'She May Own Me',
    'videos.exhibitions': 'Exibições e menções',
    'videos.spellsDescription': 'O vídeo de Spells foi selecionado para o 15º Mostra Curta de Campinas e recebeu uma menção honrosa no Chroma Awards.',
  },
  'en': {
    'nav.home': 'HOME',
    'nav.music': 'MUSIC',
